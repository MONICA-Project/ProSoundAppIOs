...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        UITabBar.appearance().tintColor = UIColor.monicaBlue()
        // We can use a 1px image with the color we want for the shadow image
        UINavigationBar.appearance().shadowImage = UIColor.monicaBlue().as1ptImage()
        ...
        //UINavigationBar.appearance().set.setBackgroundImage(UIColor.yellow.as1ptImage(), forBarMetrics: .Default)
